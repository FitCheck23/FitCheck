...
public:
	...
	static FTCPComponent& createFTCPComponent();
	bool InitSocketConnection(FString ServerIP, int32 ServerPort);
	void CloseSocketConnection();
	void SendPoseData(const PoseData& Data);

	FTCPComponent(FTCPComponent const&) = delete;
	void operator=(FTCPComponent const&) = delete;
private:
	FTCPComponent();
	bool Connected;
	FSocket* Socket;
